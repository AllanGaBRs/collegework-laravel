<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data" style="max-width: 400px;">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\allan\college-laravel-crud-main\resources\views/products/edit.blade.php ENDPATH**/ ?>