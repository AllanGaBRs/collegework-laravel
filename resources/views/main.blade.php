    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card card-category">
                <img src="{{ asset('assets/products-img.jpeg') }}"" class=" card-img-top" alt="Produtos">
                <div class="card-body text-center">
                    <h5 class="card-title">Produtos</h5>
                    <p class="card-text">Gerencie todos os seus produtos com facilidade.</p>
                    <a href="{{ route('products.index') }}" class="btn btn-outline-success">Acessar</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-category">
                <img src="{{ asset('assets/suppliers-img.jpg') }}" class="card-img-top" alt="Fornecedores">
                <div class="card-body text-center">
                    <h5 class="card-title">Fornecedores</h5>
                    <p class="card-text">Mantenha controle total sobre seus fornecedores.</p>
                    <a href="{{ route('suppliers.index') }}" class="btn btn-outline-primary">Acessar</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-category">
                <img src="{{ asset('assets/students-img.jpg') }}" class="card-img-top" alt="Alunos">
                <div class="card-body text-center">
                    <h5 class="card-title">Alunos</h5>
                    <p class="card-text">Veja a lista de alunos cadastrados no sistema.</p>
                    <a href="{{ route('students') }}" class="btn btn-outline-warning">Acessar</a>
                </div>
            </div>
        </div>
    </div>
